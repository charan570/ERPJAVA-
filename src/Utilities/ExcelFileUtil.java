...
public class ExcelFileUtil {
	...
	{
		FileInputStream fis=new FileInputStream("D:\\Charan\\ERP_STOCK\\TestInput\\supplier.xlsx");
...
return wb.getSheet(sheetname).getRow(0).getLastCellNum();		
	...
	throws Throwable{
		...
		FileOutputStream fos=new FileOutputStream("D:\\Charan\\ERP_STOCK\\TestOutput\\Hybrid 1.xlsx");
		wb.write(fos);
		fos.close();
		//wb.close();
	}
